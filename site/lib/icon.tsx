import { createIcon as chakraCreateIcon, IconProps } from "@chakra-ui/react";
...
export const EllipseFilled: React.FC<Props> = (props) => (
  <Path
    d="M12 22c5.5 0 10-4.5 10-10S17.5 2 12 2S2 6.5 2 12s4.5 10 10 10z"
    {...props}
  />
);
...
export const createIcon: typeof chakraCreateIcon = (options) => {
  return chakraCreateIcon({
    ...options,
    defaultProps: { boxSize: "icon.default", ...options.defaultProps },
  });
};
